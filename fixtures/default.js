    ...
    , data: {
        local_test_step: {
            ...
            input: {
                ...
                selector: '(behaviors["behavior_53"] > 0 and behaviors["behavior_54"] > 0)'
                , behaviors: '[{"window": "90d", "name": "behavior_53", "event_selectors": [{"event": "build-app"}]}, {"window": "90d", "name": "behavior_54", "event_selectors": [{"event": "find-app"}]}]'
            }
        }
    }
}, env);
